var utils = {
  ...
  createSearchUrl: function(str) {
    return "http://www.google.com/search?q=" + str;
  },

  makeAjaxRequest: function(type, url, callback) {
  ...
  /*
   * Ensures :fn is only called if it has been invoked only once in the past :bounceInterval seconds.
   * Useful for rate limiting.
   */
  debounce: function(fn, bounceInterval) {
    var timeoutId = null;
    return function() {
